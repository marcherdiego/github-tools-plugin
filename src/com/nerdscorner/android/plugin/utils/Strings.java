...
public final class Strings {
    ...
    public static final String EMPTY_ORGANIZATION_NAME = "The organization name cannot be empty";
    public static final String VERIFY_OAUTH_TOKEN = "Verify your organization name and your oauth token and its permissions";
    public static final String LOGGED_AS = "Logged as %s (%s)";
